 ...
 */
export function damerauLevenshtein(source, target) {
    const sourceLength = source.length;
    const targetLength = target.length;
    const distanceTable = Array.from({ length: sourceLength + 1 }, () => new Array(targetLength + 1).fill(0));
 ...
 */
export class BKTree {
    constructor(distanceFn = damerauLevenshtein) {
